    ...
    <div className="no-scrollbar relative mx-auto w-[96%] pt-0 pb-32 md:w-[96%] lg:w-1/2 xl:w-1/2 2xl:w-1/2 min-h-screen">
      ...
      <div className="border-dashed border-zinc-200 dark:border-white/20 pb-10 mt-12 border-b">
        <div className="group flex flex-col items-start gap-y-6 lg:flex-row lg:items-center">
          ...
          <div className="group/me relative h-72 w-full lg:w-[40%] cursor-pointer overflow-hidden rounded-xl border border-zinc-200 dark:border-white/10 hover:border-emerald-500/50 transition-all shadow-lg dark:shadow-xl">
          ...
          <div className="flex w-full flex-col justify-center gap-y-6 pt-3 lg:w-[60%] lg:pl-8 lg:pt-0">
